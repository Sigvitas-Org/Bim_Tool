...
return new class extends Migration {
    ...
    public function up()
    {
        ...
        Schema::table('companies', function (Blueprint $table) {
            ...
            $table->dropColumn('google_recaptcha_v2_status');
            $table->dropColumn('google_recaptcha_v2_site_key');
            $table->dropColumn('google_recaptcha_v2_secret_key');
            $table->dropColumn('google_recaptcha_v3_status');
            $table->dropColumn('google_recaptcha_v3_site_key');
            $table->dropColumn('google_recaptcha_v3_secret_key');
            ...
            $table->dropColumn('show_review_modal');
