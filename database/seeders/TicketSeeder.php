...
class TicketSeeder extends Seeder
{
    ...
    public function run($companyId)
    {
        ...
        TicketGroup::factory()->count((int)$count)
            ->make()
            ->each(function (TicketGroup $ticket) use ($companyId) {
        ...
        \App\Models\Ticket::factory($companyId)->count((int)$count)
            ->make()
            ->each(function (Ticket $ticket) use ($faker, $count, $companyId, $type, $user, $channel, $agent) {
