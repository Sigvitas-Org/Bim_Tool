...
return array(
    ...
    'update' => array(
        ...
        'moduleFile' => 'After uploading the zip, you will see the modules below. Click on install button to install or update the respective module. You will be logged out, once you click Install button.
     Once installed, you will be able to see that module on Module list. You can activate or deactivate the module from there',
    ),
    ...
    'holiday' => array(
        ...
        'officeHolidayMarkDays' => 'Mark days for default Holidays',
    ),
    'department' => array(
        'title' => 'Department',
    ...
    'module' => array(
        ...
        'sms' => 'SMS',
        'knowledgebase' => 'Knowledge Base',
        'addknowledgebaseCategory' => 'Manage Knowledge Base Category',
