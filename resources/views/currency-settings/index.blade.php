                ...
                <div class="s-b-n-header" id="tabs">
                    <nav class="tabs px-4 border-bottom-grey">
                        <div class="nav" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link f-15 active currency-setting"
                               href="{{ route('currency-settings.index') }}" role="tab" aria-controls="nav-ticketAgents"
                               aria-selected="true">@lang('modules.accountSettings.currencySetting')
                            </a>
                            <a class="nav-item nav-link f-15 currency-format-setting"
                               href="{{route('currency-settings.index')}}?tab=currency-format-setting" role="tab"
                               aria-controls="nav-ticketTypes" aria-selected="true"
                               ajax="false"> @lang('modules.accountSettings.currencyFormatSetting')
                            </a>
                        </div>
                    </nav>
                </div>
