                        ...
                        <ul class="nav -primary" id="nav-tab" role="tablist">
                            ...
                            <li>
                                <a class="nav-item nav-link f-15 stripe" data-toggle="tab"
                                   ...
                                   aria-controls="nav-stripe" aria-selected="false"><i class="fab fa-stripe-s f-12"></i> @lang('app.stripe') <i
                            ...
                            <li>
                                <a class="nav-item nav-link f-15 razorpay" data-toggle="tab"
                                   ...
                                   aria-controls="nav-razorpay" aria-selected="false"><img style="height: 15px;" src="{{ asset('img/razorpay.png') }}"> @lang('app.razorpay') <i
                            ...
                            <li>
                                <a class="nav-item nav-link f-15 paystack" data-toggle="tab"
                                   ...
                                   aria-controls="nav-paystack" aria-selected="false"><img style="height: 15px;" src="{{ asset('img/paystack.jpg') }}"> @lang('app.paystack') <i
                            ...
                            <li>
                                <a class="nav-item nav-link f-15 mollie" data-toggle="tab"
                                   ...
                                   aria-controls="nav-mollie" aria-selected="false"><img style="height: 10px;"
                                                                                         src="{{ asset('img/mollie.svg') }}"> @lang('app.mollie') <i
                            ...
                            <li>
                                <a class="nav-item nav-link f-15 payfast" data-toggle="tab"
                                   ...
                                   aria-controls="nav-payfast" aria-selected="false"><img style="height: 15px;" src="{{ asset('img/payfast-logo.png') }}"> @lang('app.payfast') <i
                            ...
                            <li>
                                <a class="nav-item nav-link f-15 authorize" data-toggle="tab"
                                   ...
                                   aria-controls="nav-authorize" aria-selected="false"><img style="height: 15px;" src="{{ asset('img/authorize.png') }}"> @lang('app.authorize') <i
                            ...
                            <li>
                                <a class="nav-item nav-link f-15 square" data-toggle="tab"
                                   ...
                                   aria-controls="nav-square" aria-selected="false"><img style="height: 15px;" src="{{ asset('img/square.svg') }}"> @lang('app.square') <i
                                        class="fa fa-circle ml-1 {{ $credentials->square_status == 'active' ? 'text-light-green' : 'text-red' }}"></i>
                                </a>
                            </li>
                            <li>
                                <a class="nav-item nav-link f-15 flutterwave" data-toggle="tab"
                                   ...
                                   aria-controls="nav-flutterwave" aria-selected="false"><img style="height: 15px;"
                                                                                              src="{{ asset('img/flutterwave.png') }}"> @lang('app.flutterwave') <i
                                        class="fa fa-circle ml-1 {{ $credentials->flutterwave_status == 'active' ? 'text-light-green' : 'text-red' }}"></i>
                                </a>
                            </li>
