        ...
        <div class="bg-white rounded b-shadow-4 create-inv">
            ...
            <x-form class="c-inv-form" id="saveInvoiceForm">
                        ...
                        <div class="form-group c-inv-select mb-4">
                            ...
                            <select class="form-control select-picker" data-live-search="true" data-size="8"
                                ...
                                @foreach ($clients as $client)
                                    <x-user-option :user="$client" :selected="$client->id == $invoice->client_id"/>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="row px-lg-4 px-md-4 px-3 py-3">
                    ...
                    <div class="col-md-6 {{ company()->show_shipping_address == 'yes' ? '' : 'd-none' }}  "
                ...
                <div class="px-lg-4 px-md-4 px-3 py-3 c-inv-btns">
                    <div class="d-flex">
                        <x-forms.button-cancel :link="route('recurring-invoices.index')" class="border-0 mr-2">@lang('app.cancel')
