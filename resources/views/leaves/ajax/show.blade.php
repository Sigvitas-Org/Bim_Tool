        ...
        <div class="col-sm-12">
            <div class="card bg-white border-0 b-shadow-4">
                <div class="card-header bg-white  border-bottom-grey text-capitalize justify-content-between p-20">
                    <div class="row">
                        <div class="col-md-10 col-10">
                            ...
                            <div class="f-10 text-lightest">@lang('app.apply')  @lang('app.date') - {{ $leave->created_at->timezone(company()->timezone)->format(company()->date_format .' ' . company()->time_format) }}</div>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <x-cards.data-row :label="__('modules.leaves.leaveDate')" :value="$leave->leave_date->format(company()->date_format)"
                        html="true" />
                    ...
                    @if (!is_null($leave->approved_at))
                        <x-cards.data-row :label="__('modules.leaves.approvedAt')" :value="$leave->approved_at->timezone(company()->timezone)->format(company()->date_format .' ' . company()->time_format)" />
                    @endif
