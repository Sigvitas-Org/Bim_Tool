                            ...
                            <td align="right">
                                <table class="inv-num-date text-dark f-13 mt-3">
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-left-0">{{ $contract->start_date->format($company->date_format) }}
                                        </td>
                                    </tr>
                                    @if ($contract->end_date != null)
                                        <tr>
                                            ...
                                            <td class="border-left-0">{{ $contract->end_date->format($company->date_format) }}
                                            </td>
                                        </tr>
                                    @endif
                                    <tr>
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton" tabindex="0">
                            ...
                            <li>
                                <a class="dropdown-item f-14 text-dark"
                                    href="{{ route('front.contract.download', $contract->id) }}">
