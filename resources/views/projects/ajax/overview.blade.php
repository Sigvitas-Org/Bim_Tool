            ...
            <div class="col-md-6 mb-4">
                <x-cards.data :title="__('modules.projects.projectProgress')"
                    ...
                    <div class="p-start-date mb-xl-0 mb-lg-3">
                        ...
                        <p class="f-15 mb-0">{{ $project->start_date->format(company()->date_format) }}</p>
                    </div>
                    ...
                    <div class="p-end-date">
                        ...
                        <p class="f-15 mb-0">
                            {{ !is_null($project->deadline) ? $project->deadline->format(company()->date_format) : '--' }}
                        </p>
                    </div>
                    ...
                    <div class="card border-0 b-shadow-4 p-20 rounded-0">
                        <div class="card-horizontal">
                            <div class="card-header m-0 p-0 bg-white rounded">
                                <x-date-badge :month="$activity->created_at->timezone(company()->timezone)->format('M')"
                                    :date="$activity->created_at->timezone(company()->timezone)->format('d')" />
                            </div>
