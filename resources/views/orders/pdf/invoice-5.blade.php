                ...
                <td>
                    <table class="text-black mt-1 f-13 b-collapse rightaligned">
                        ...
                        <tr>
                            ...
                            <td class="heading-table-right">{{ \Carbon\Carbon::parse($order->order_date)->format(company()->date_format) }}
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <table width="100%" class="b-collapse">
                    ...
                    <tr align="right" class="text-grey">
                        <td class="subtotal-amt">
                            {{ currency_formatter($order->sub_total, '') }}</td>
                    </tr>
                    <!-- Table Row End -->
                    @if ($discount != 0 && $discount != '')
                        <!-- Table Row Start -->
                    ...
                    <tr align="right" class="balance text-black">
                        <td class="balance-right">
                            {{ currency_formatter($order->total, '') }}</td>
                    </tr>
                    <!-- Table Row End -->
                </table>
            </td>
