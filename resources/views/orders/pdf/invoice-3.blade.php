...
<div id="container">
    ...
    <section id="sums">
        ...
        <table cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td>{{ currency_formatter($order->sub_total, '') }}</td>
            </tr>
    ...
    <section id="invoice-info">
        <div>
            <span>@lang('modules.orders.orderDate'):</span> <span>{{ \Carbon\Carbon::parse($order->order_date)->format(company()->date_format) }}</span>
        </div>
