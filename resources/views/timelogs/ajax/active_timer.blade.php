                        ...
                        <tr id="timer-{{ $item->id }}">
                            ...
                            <td>
                                ...
                                <div class="mt-1 f-12">
                                    ...
                                    @else
                                        <span class="badge badge-primary" data-toggle="tooltip" data-original-title="{{ $item->activeBreak->start_time->timezone(company()->timezone)->format(company()->date_format . ' ' . company()->time_format) }}">
