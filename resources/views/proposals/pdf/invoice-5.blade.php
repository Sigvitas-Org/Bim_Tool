                ...
                <td>
                    <table class="text-black mt-1 f-13 b-collapse rightaligned">
                        ...
                        <tr>
                            ...
                            <td class="heading-table-right">{{ $proposal->valid_till->format($company->date_format) }}
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        @foreach ($proposal->items as $item)
            @if ($item->type == 'item')
                ...
                <tr class="main-table-items text-black f-14">
                    ...
                    <td align="right" class="border-bottom-0">{{ currency_formatter($item->amount, '') }}</td>
                </tr>
                ...
                <table width="100%" class="b-collapse">
                    ...
                    <tr align="right" class="text-grey">
                        <td class="subtotal-amt">
                            {{ currency_formatter($proposal->sub_total, '') }}</td>
                    </tr>
                    <!-- Table Row End -->
                    @if ($discount != 0 && $discount != '')
                        <!-- Table Row Start -->
