...
<div id="container">
        ...
        <section id="invoice-info">
            <table>
                ...
                <tr>
                    ...
                    <td>{{ $proposal->valid_till->format($company->date_format) }}</td>
                </tr>
            </table>
        ...
        <section id="client-info">
            ...
            <div>
                @if ($proposal->lead && $proposal->lead->client_name && $invoiceSetting->show_client_name == 'yes')
                    <span class="bold">{{ mb_ucwords($proposal->lead->client_name) }}</span>
                @endif
    ...
    <div class="invoice-body">
        ...
        @if ($proposal->description)
            <div class="f-13 mb-3 description">{!! nl2br(strip_tags($proposal->description, ['p', 'b', 'strong', 'a', 'ul', 'li', 'ol', 'i', 'u', 'em', 'blockquote', 'img'])) !!}</div>
        @endif
        ...
        <section id="items">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr class="amount-total">
                    ...
                    <td>
                        {{ currency_formatter($proposal->total, '') }} {!! htmlentities($proposal->currency->currency_code) !!}
                    </td>
                </tr>
            </table>
