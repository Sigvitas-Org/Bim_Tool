        ...
        <div class="right-invoice">
            ...
            @elseif(!is_null($invoice->client_id))
                <section id="client-info">
                    <span>@lang('modules.invoices.billedTo'):</span>
                    <div class="client-name">
                        <strong>{{ mb_ucwords($invoice->client->name) }}</strong>
                    </div>
            ...
            <section id="invoice-info">
                @if (empty($invoice->order_id) && $invoice->status === 'unpaid' && $invoice->due_date->year > 1)
                    <div>
                        ...
                        <span>{{ $invoice->due_date->format($company->date_format) }}</span>
                    </div>
                @endif
                <div>
            ...
            <section id="sums">
                ...
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td>{{ currency_formatter($invoice->sub_total, '') }}</td>
                    </tr>
                    ...
                    <tr class="amount-total">
                        ...
                        <td>{{ currency_formatter($invoice->total, '') }}</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td> {{ currency_formatter($invoice->getPaidAmount(), '') }}</td>
                    </tr>
                    <tr>
                        <th>@lang('modules.invoices.total') @lang('modules.invoices.due'):</th>
                        <td> {{ currency_formatter($invoice->amountDue(), '') }}</td>
                    </tr>
                </table>
