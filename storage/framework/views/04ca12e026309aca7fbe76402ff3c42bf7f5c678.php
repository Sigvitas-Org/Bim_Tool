...
<?php $component = App\View\Components\Forms\LinkPrimary::resolve(['link' => route('leads.create'),'icon' => 'plus'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes(['class' => 'mr-3 openRightModal float-left mb-2 mb-lg-0 mb-md-0']); ?>
                        ...
                        <?php echo app('translator')->get('app.lead'); ?>
...
<?php $component = App\View\Components\Forms\LinkSecondary::resolve(['link' => route('leads.import'),'icon' => 'file-upload'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                <div class="select-status mr-3 pl-3">
                    <select name="action_type" class="form-control select-picker" id="quick-action-type" disabled>
                        ...
                        <option value="change-agent"><?php echo app('translator')->get('modules.lead.changeAgent'); ?></option>
                ...
                <div class="select-status mr-3 d-none quick-action-field" id="change-status-action">
                    <select name="status" class="form-control select-picker">
                        <?php $__currentLoopData = $status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($st->id); ?>"><?php echo e(ucwords($st->type)); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
             <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
            ...
            <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group">
                <a href="<?php echo e(route('leads.index')); ?>" class="btn btn-secondary f-14 btn-active" data-toggle="tooltip"
    ...
    <script>
        ...
        $('body').on('click', '.delete-table-row', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "<?php echo e(route('leads.destroy', ':id')); ?>";
        ...
        $('#leads-table').on('change', '.change-status', function() {
            var url = "<?php echo e(route('leads.change_status')); ?>";
            var token = "<?php echo e(csrf_token()); ?>";
        ...
        function followUp(leadID) {
            var url = '<?php echo e(route('leads.follow_up', ':id')); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u561154491/domains/builtinmysore.com/public_html/resources/views/leads/index.blade.php ENDPATH**/ ?>