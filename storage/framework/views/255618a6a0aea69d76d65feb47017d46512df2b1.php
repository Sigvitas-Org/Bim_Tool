                    ...
                    <a href="javascript:;" id="totalEarnings">
                        <div class="d-flex">
                            <?php if(in_array('total_expenses', $activeWidgets)): ?>
                                <p class="mb-0 f-15 font-weight-bold text-blue d-grid mr-5">
                                    <?php echo e(currency_formatter($totalExpenses)); ?><span
                            ...
                            <?php if(in_array('total_earnings', $activeWidgets)): ?>
                                <p class="mb-0 f-15 font-weight-bold text-dark-green d-grid">
                                    <?php echo e(currency_formatter($totalEarnings)); ?><span
...
<?php $component = App\View\Components\Cards\Widget::resolve(['title' => __('modules.dashboard.totalPendingAmount'),'value' => currency_formatter($totalPendingAmount),'icon' => 'coins'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH /home/u561154491/domains/builtinmysore.com/public_html/resources/views/dashboard/ajax/finance.blade.php ENDPATH**/ ?>