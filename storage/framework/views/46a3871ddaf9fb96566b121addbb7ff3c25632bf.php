...
<?php $component->withAttributes([]); ?>
                <?php $__currentLoopData = $dateFormat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $format): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($format); ?>"
                            <?php if(company()->date_format == $format): ?> selected <?php endif; ?>>
                        <?php echo e($format); ?> (<?php echo e($dateObject->format($format)); ?>)
                    </option>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                <option value="h:i A" <?php if(company()->time_format == 'h:i A'): ?> selected <?php endif; ?>>
                    12 Hour (<?php echo e(now(company()->timezone)->format('h:i A')); ?>)
                </option>
                <option value="h:i a" <?php if(company()->time_format == 'h:i a'): ?> selected <?php endif; ?>>
                    12 Hour (<?php echo e(now(company()->timezone)->format('h:i a')); ?>)
                </option>
                <option value="H:i" <?php if(company()->time_format == 'H:i'): ?> selected <?php endif; ?>>
                    24 Hour (<?php echo e(now(company()->timezone)->format('H:i')); ?>)
                </option>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalaa9e2e00dcec6b58db49b9128f7191370bc93381)): ?>
...
<?php $component->withAttributes([]); ?>
                <?php $__currentLoopData = $timezones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option <?php if(company()->timezone == $tz): ?> selected <?php endif; ?>><?php echo e($tz); ?>
...
<?php endif; ?>
        ...
        <div class="col-lg-2">
            <?php if (isset($component)) { $__componentOriginalaa9e2e00dcec6b58db49b9128f7191370bc93381 = $component; } ?>
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'currency_id','fieldLabel' => __('modules.accountSettings.defaultCurrency'),'fieldName' => 'currency_id','search' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Select::class))->getConstructor()): ?>
...
<?php $component->withAttributes([]); ?>
                <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option <?php if($currency->id == company()->currency_id): ?>
                            selected
...
<?php $component->withAttributes([]); ?>
                <?php $__currentLoopData = $languageSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option <?php echo e(company()->locale == $language->language_code ? 'selected' : ''); ?>
...
<?php /**PATH /home/u561154491/domains/builtinmysore.com/public_html/resources/views/app-settings/ajax/app-setting.blade.php ENDPATH**/ ?>