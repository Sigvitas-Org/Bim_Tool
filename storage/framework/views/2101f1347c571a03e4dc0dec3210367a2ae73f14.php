...
<?php endif; ?>
    ...
    <div class="page-header-right float-right d-flex align-items-center">
        ...
        <ul>
            <!-- SEARCH START -->
            <li data-toggle="tooltip" data-placement="top" title="<?php echo e(__('app.search')); ?>">
        ...
        <!-- NOTIFICATIONS START -->
            <li data-toggle="tooltip" data-placement="top" title="<?php echo e(__('app.newNotifications')); ?>">
...
<?php /**PATH /home/u561154491/domains/builtinmysore.com/public_html/resources/views/sections/topbar.blade.php ENDPATH**/ ?>