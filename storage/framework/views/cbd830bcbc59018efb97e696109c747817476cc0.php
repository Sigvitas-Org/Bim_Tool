<script type="text/javascript">
    ...
    $('#update-app').click(function () {
        ...
        let supportText = " Your support has been expired on <b><span id='support-date'><?php echo e(\Carbon\Carbon::parse($envatoUpdateCompanySetting->supported_until)->format('dS M, Y')); ?></span></b>";
        ...
        Swal.fire({
            ...
            title: "Are you sure?",
            html: `<?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'danger','icon' => 'info-circle']); ?>Do not click update now button if the application is customised. Your changes will be lost.\n
                <br>
                <br>
...
<?php /**PATH /home/u561154491/domains/builtinmysore.com/public_html/resources/views/vendor/froiden-envato/update/update_script.blade.php ENDPATH**/ ?>