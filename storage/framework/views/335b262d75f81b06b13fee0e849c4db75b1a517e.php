        ...
        <div class="minimized rounded bg-additional-grey border-grey mr-3">
            ...
            <div class="d-flex mt-4 mx-1 b-p-header align-items-center">
                <a href="javascript:;" class="d-grid f-8 mb-3 text-lightest collapse-column"
                    data-column-id="<?php echo e($column->id); ?>" data-type="maximize">
                    <i class="fa fa-chevron-right ml-1"></i>
                    <i class="fa fa-chevron-left"></i>
                </a>

                <p class="mb-3 mx-0 f-15 text-dark-grey font-weight-bold"><i class="fa fa-circle mb-2 text-red"
                        style="color: <?php echo e($column->label_color); ?>"></i><?php echo e($column->slug == 'completed' || $column->slug == 'incomplete' ? __('app.' . $column->slug) : mb_ucwords($column->column_name)); ?></p>
        ...
        <div class="board-panel rounded bg-additional-grey border-grey mr-3">
            ...
            <div class="d-flex m-3 b-p-header">
                <p class="mb-0 f-15 mr-3 text-dark-grey font-weight-bold"><i class="fa fa-circle mr-2 text-yellow"
                        style="color: <?php echo e($column->label_color); ?>"></i><?php echo e(mb_ucwords($column->column_name)); ?>
                ...
                <span class="ml-auto d-flex align-items-center">
                    ...
                    <a href="javascript:;" class="d-flex f-8 text-lightest collapse-column"
                        data-column-id="<?php echo e($column->id); ?>" data-type="minimize">
                            ...
                            <div class="dropdown-menu dropdown-menu-right border-grey rounded b-shadow-4 p-0"
                                ...
                                <?php if($addTaskPermission == 'all' || $addTaskPermission == 'added'): ?>
                                    <a class="dropdown-item openRightModal"
                                        href="<?php echo e(route('tasks.create')); ?>?column_id=<?php echo e($column->id); ?>"><?php echo app('translator')->get('app.add'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cards.task-card','data' => ['draggable' => (($changeStatusPermission == 'all' || ($task->project && $task->project->project_admin == user()->id)) ? 'true' : 'false'),'task' => $task]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['draggable' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute((($changeStatusPermission == 'all' || ($task->project && $task->project->project_admin == user()->id)) ? 'true' : 'false')),'task' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($task)]); ?>
...
<?php /**PATH /home/u561154491/domains/builtinmysore.com/public_html/resources/views/taskboard/board_data.blade.php ENDPATH**/ ?>