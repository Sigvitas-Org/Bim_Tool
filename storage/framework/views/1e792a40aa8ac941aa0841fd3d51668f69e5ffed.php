...
<?php endif; ?>
        ...
        <?php if(user()->permission('manage_finance_setting') == 'all'): ?>
            <?php if (isset($component)) { $__componentOriginalcd728ade001f05c9f58f8d190a481136e39bd167 = $component; } ?>
...
<?php endif; ?>
        ...
        <?php if(user()->permission('manage_ticket_setting') == 'all'): ?>
            <?php if (isset($component)) { $__componentOriginalcd728ade001f05c9f58f8d190a481136e39bd167 = $component; } ?>
...
<?php endif; ?>
        ...
        <?php if(user()->permission('manage_project_setting') == 'all'): ?>
            <?php if (isset($component)) { $__componentOriginalcd728ade001f05c9f58f8d190a481136e39bd167 = $component; } ?>
...
<?php endif; ?>
        ...
        <?php if(user()->permission('manage_attendance_setting') == 'all'): ?>
            <?php if (isset($component)) { $__componentOriginalcd728ade001f05c9f58f8d190a481136e39bd167 = $component; } ?>
...
<?php endif; ?>
        ...
        <?php if(user()->permission('manage_leave_setting') == 'all'): ?>
            <?php if (isset($component)) { $__componentOriginalcd728ade001f05c9f58f8d190a481136e39bd167 = $component; } ?>
...
<?php endif; ?>
        ...
        <?php if(user()->permission('manage_message_setting') == 'all'): ?>
            <?php if (isset($component)) { $__componentOriginalcd728ade001f05c9f58f8d190a481136e39bd167 = $component; } ?>
...
<?php endif; ?>
        ...
        <?php if(user()->permission('manage_lead_setting') == 'all'): ?>
            <?php if (isset($component)) { $__componentOriginalcd728ade001f05c9f58f8d190a481136e39bd167 = $component; } ?>
...
<?php endif; ?>
        ...
        <?php if(user()->permission('manage_time_log_setting') == 'all'): ?>
            <?php if (isset($component)) { $__componentOriginalcd728ade001f05c9f58f8d190a481136e39bd167 = $component; } ?>
...
<?php endif; ?>
        ...
        <?php if(user()->permission('manage_task_setting') == 'all'): ?>
            <?php if (isset($component)) { $__componentOriginalcd728ade001f05c9f58f8d190a481136e39bd167 = $component; } ?>
...
<?php endif; ?>
        ...
        <?php if(user()->permission('manage_gdpr_setting') == 'all'): ?>
            <?php if (isset($component)) { $__componentOriginalcd728ade001f05c9f58f8d190a481136e39bd167 = $component; } ?>
...
<?php endif; ?>
        ...
        <?php $__currentLoopData = worksuite_plugins(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(View::exists(strtolower($item) . '::sections.setting-sidebar')): ?>
                <?php echo $__env->make(strtolower($item).'::sections.setting-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
...
<?php /**PATH /home/u561154491/domains/builtinmysore.com/public_html/resources/views/components/setting-sidebar.blade.php ENDPATH**/ ?>