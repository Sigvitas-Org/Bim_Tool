            ...
            <div class="row">
                <div class="col-md-12">
                    <span class="f-w-500 mr-1"><?php echo app('translator')->get('app.note'); ?>:</span> <i class="fa fa-star text-warning"></i> <i
                        class="fa fa-arrow-right text-lightest f-11 mx-1"></i> <?php echo app('translator')->get('app.menu.holiday'); ?> &nbsp;|&nbsp;
                    <i
                        class="fa fa-check text-primary"></i> <i class="fa fa-arrow-right text-lightest f-11 mx-1"></i>
                    <?php echo app('translator')->get('modules.attendance.present'); ?> &nbsp;|&nbsp; <i class="fa fa-times text-lightest"></i> <i
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        var viewAttendancePermission = '<?php echo e($viewAttendancePermission); ?>';

        userRoleAdmin = "<?php echo e(in_array('admin', user_roles())); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u561154491/domains/builtinmysore.com/public_html/resources/views/attendances/index.blade.php ENDPATH**/ ?>