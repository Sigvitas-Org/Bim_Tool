...
<?php endif; ?>
    ...
    <input type="text" class="form-control <?php echo e($custom ? 'custom-date-picker' : ''); ?> date-picker height-35 f-14"
        placeholder="<?php echo e($fieldPlaceholder); ?>" value="<?php echo e($fieldValue); ?>" name="<?php echo e($fieldName); ?>"
...
<?php /**PATH /home/u561154491/domains/builtinmysore.com/public_html/resources/views/components/forms/datepicker.blade.php ENDPATH**/ ?>