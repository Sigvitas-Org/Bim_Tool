<div class="d-flex justify-content-between">
    <div>
        <div class='input-group'>
            ...
            <input type="text" disabled class="form-control height-35 f-14 bg-white text-center" value="<?php echo e($weekStartDate->format('d M') . ' - ' . $weekEndDate->format('d M')); ?>">
            ...
            <?php $__currentLoopData = $weekPeriod->toArray(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <th class="px-1">
                    <div class="d-flex">
                        ...
                        <div class="text-lightest f-11 text-uppercase"><?php echo e($date->format('l')); ?> <br><?php echo e($date->format('M')); ?></div>
                    </div>
                </th>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
         <?php $__env->endSlot(); ?>
                            ...
                            <?php if($day == 'Leave'): ?>
                                ...
                                <?php elseif($day == 'EMPTY'): ?>
                                    <button type="button" class="py-4 change-shift-week badge badge-light f-14 p-1 border w-100"  data-user-id="<?php echo e($userId); ?>"
                                        data-attendance-date="<?php echo e($key2); ?>"><i class="fa fa-plus-circle"></i></button>
...
<?php /**PATH /home/u561154491/domains/builtinmysore.com/public_html/resources/views/shift-rosters/ajax/week_summary_data.blade.php ENDPATH**/ ?>