...
<div class="row py-0 py-md-0 py-lg-3">
    <div class="col-lg-12 col-md-12 mb-4 mb-xl-0 mb-lg-4">
        ...
        <div class="d-flex justify-content-between action-bar mt-4">

            <div id="table-actions" class="d-flex align-items-center">

                <?php if($addProjectPermission == 'all' || $addProjectPermission == 'added'): ?>
                    <?php if (isset($component)) { $__componentOriginal7f662ecf9f97aca611d2405e5e6903e6081fbd17 = $component; } ?>
<?php $component = App\View\Components\Forms\LinkPrimary::resolve(['link' => route('projects.create').'?default_assign='.$employee->id,'icon' => 'plus'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    $('#projects-table').on('preXhr.dt', function(e, settings, data) {
        ...
        var employee_id = "<?php echo e($employee->id); ?>";
...
<?php /**PATH /home/u561154491/domains/builtinmysore.com/public_html/resources/views/employees/ajax/projects.blade.php ENDPATH**/ ?>