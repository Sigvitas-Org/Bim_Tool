...
<?php $component = App\View\Components\Cards\Data::resolve(['title' => __('app.earnings').' <i class=\'fa fa-question-circle\' data-toggle=\'popover\' data-placement=\'top\' data-content=\''.__('app.from').' '.$startDate->format(company()->date_format).' '.__('app.to').' '.$endDate->format(company()->date_format).'\' data-trigger=\'hover\'></i>'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
    ...
    <?php if(in_array('timelogs', $modules) && in_array('timelogs', $activeWidgets)): ?>
        <div class="col-sm-12 col-lg-6 mt-3">
            <?php if (isset($component)) { $__componentOriginalf463d4507b04ddbb1ec93225959f845404a19c7e = $component; } ?>
...
<?php endif; ?>
    ...
    <?php if(in_array('leaves', $modules) && in_array('settings_leaves', $activeWidgets)): ?>
        <div class="col-sm-12 col-lg-6 mt-3">
            <?php if (isset($component)) { $__componentOriginalf463d4507b04ddbb1ec93225959f845404a19c7e = $component; } ?>
<?php $component = App\View\Components\Cards\Data::resolve(['title' => __('modules.leaves.pendingLeaves').' <i class=\'fa fa-question-circle\' data-toggle=\'popover\' data-placement=\'top\' data-content=\''.__('app.from').' '.$startDate->format(company()->date_format).' '.__('app.to').' '.$endDate->format(company()->date_format).'\' data-trigger=\'hover\'></i>','padding' => 'false','otherClasses' => 'h-200'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('cards.data'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Cards\Data::class))->getConstructor()): ?>
...
<?php endif; ?>
                            ...
                            <td class="text-darkest-grey"><?php echo e($item->leave_date->format(company()->date_format)); ?></td>
                            <td class="f-14">
                                ...
                                <div class="task_view">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right"
                                            ...
                                            <a class="dropdown-item leave-action-approved" data-leave-id='<?php echo e($item->id); ?>'
...
<?php $component->withAttributes([]); ?>
                    <?php $__empty_1 = true; $__currentLoopData = $newTickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td><a href="<?php echo e(route('tickets.show', $item->id)); ?>"
                                    class="text-darkest-grey"><?php echo e(ucfirst($item->subject)); ?></a>
                                <br />
                                <span class="f-10 text-lightest mt-1"><?php echo e($item->requester->name); ?></span>
                            </td>
                            <td class="text-darkest-grey" width="15%"><?php echo e($item->updated_at->format(company()->date_format)); ?></td>
                        ...
                        <tr>
                            <td class="pl-20">
                                <h5 class="f-13 text-darkest-grey"><a href="<?php echo e(route('tasks.show', [$task->id])); ?>"
                                        class="openRightModal"><?php echo e($task->heading); ?></a></h5>
                                    ...
                                    <div class="taskEmployeeImg rounded-circle mr-1">
                                        <a href="<?php echo e(route('employees.show', $item->id)); ?>">
                                            <img data-toggle="tooltip"
                                                data-original-title="<?php echo e(mb_ucwords($item->name)); ?>"
                                                src="<?php echo e($item->image_url); ?>">
                                        </a>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </td>
                            <td width="15%"><?php if(!is_null($task->due_date)): ?> <?php echo e($task->due_date->format(company()->date_format)); ?> <?php else: ?> -- <?php endif; ?></td>
                            <td class="f-14" width="20%">
                                <?php if (isset($component)) { $__componentOriginal2db42a9094af8c45b35737ea3527d3c0817d84c4 = $component; } ?>
                        ...
                        <tr>
                            <td class="pl-20">
                                <h5 class="f-13 text-darkest-grey"><a
                                        href="<?php echo e(route('leads.show', [$item->id])); ?>"><?php echo e($item->client_name); ?></a>
                                </h5>
                                <div class="text-muted"><?php echo e($item->company_name); ?></div>
                            </td>
                            <td>
                                <?php echo e(\Carbon\Carbon::parse($item->follow_up_date_past)->timezone(company()->timezone)->format(company()->date_format)); ?>
                            ...
                            <div class="card-body border-0 p-0 ml-3">
                                ...
                                <p class="card-text f-12 text-dark-grey">
                                    <a href="<?php echo e(route('projects.show', $activity->project_id)); ?>"
                                        class="text-lightest font-weight-normal text-capitalize f-12"><?php echo e(mb_ucwords($activity->project->project_name)); ?>
                            ...
                            <div class="card-body border-0 p-0 ml-3">
                                ...
                                <p class="card-text f-12 text-dark-grey">
                                    <a href="<?php echo e(route('employees.show', $activity->user_id)); ?>"
                                        class="text-lightest font-weight-normal text-capitalize f-12"><?php echo e(mb_ucwords($activity->user->name)); ?>
...
<?php /**PATH /home/u561154491/domains/builtinmysore.com/public_html/resources/views/dashboard/ajax/overview.blade.php ENDPATH**/ ?>