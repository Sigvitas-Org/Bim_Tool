...
<?php $component = App\View\Components\Cards\Notification::resolve(['notification' => $notification,'link' => route('leaves.show', $notification->data['id']),'image' => $notificationUser->image_url,'title' => __('email.leave.applied'),'text' => \Carbon\Carbon::parse($notification->data['leave_date'])->format(company()->date_format),'time' => $notification->created_at] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php /**PATH /home/u561154491/domains/builtinmysore.com/public_html/resources/views/notifications/all/leave_application.blade.php ENDPATH**/ ?>