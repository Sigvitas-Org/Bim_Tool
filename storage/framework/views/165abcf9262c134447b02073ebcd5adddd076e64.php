                        ...
                        <ul class="nav -primary" id="nav-tab" role="tablist">
                            <li>
                                ...
                                <a class="nav-item nav-link f-15 active paypal" data-toggle="tab"
                                   ...
                                   aria-selected="true"><i class="fab fa-paypal f-12"></i> <?php echo app('translator')->get('app.paypal'); ?> <i
                                        class="fa fa-circle ml-1 <?php echo e($credentials->paypal_status == 'active' ? 'text-light-green' : 'text-red'); ?>"></i>
                                </a>
                            </li>
                            <li>
                                <a class="nav-item nav-link f-15 stripe" data-toggle="tab"
                                   ...
                                   aria-controls="nav-stripe" aria-selected="false"><i class="fab fa-stripe-s f-12"></i> <?php echo app('translator')->get('app.stripe'); ?> <i
                                        class="fa fa-circle ml-1 <?php echo e($credentials->stripe_status == 'active' ? 'text-light-green' : 'text-red'); ?>"></i>
                                </a>
                            </li>
                            <li>
                                <a class="nav-item nav-link f-15 razorpay" data-toggle="tab"
                                   ...
                                   aria-controls="nav-razorpay" aria-selected="false"><img style="height: 15px;" src="<?php echo e(asset('img/razorpay.png')); ?>"> <?php echo app('translator')->get('app.razorpay'); ?> <i
                                        class="fa fa-circle ml-1 <?php echo e($credentials->razorpay_status == 'active' ? 'text-light-green' : 'text-red'); ?>"></i>
                                </a>
                            </li>
                            <li>
                                <a class="nav-item nav-link f-15 paystack" data-toggle="tab"
                                   ...
                                   aria-controls="nav-paystack" aria-selected="false"><img style="height: 15px;" src="<?php echo e(asset('img/paystack.jpg')); ?>"> <?php echo app('translator')->get('app.paystack'); ?> <i
                                        class="fa fa-circle ml-1 <?php echo e($credentials->paystack_status == 'active' ? 'text-light-green' : 'text-red'); ?>"></i>
                                </a>
                            </li>
                            <li>
                                <a class="nav-item nav-link f-15 mollie" data-toggle="tab"
                                   ...
                                   aria-controls="nav-mollie" aria-selected="false"><img style="height: 10px;"
                                                                                         src="<?php echo e(asset('img/mollie.svg')); ?>"> <?php echo app('translator')->get('app.mollie'); ?> <i
                                        class="fa fa-circle ml-1 <?php echo e($credentials->mollie_status == 'active' ? 'text-light-green' : 'text-red'); ?>"></i>
                                </a>
                            </li>
                            <li>
                                <a class="nav-item nav-link f-15 payfast" data-toggle="tab"
                                   ...
                                   aria-controls="nav-payfast" aria-selected="false"><img style="height: 15px;" src="<?php echo e(asset('img/payfast-logo.png')); ?>"> <?php echo app('translator')->get('app.payfast'); ?> <i
                                        class="fa fa-circle ml-1 <?php echo e($credentials->payfast_status == 'active' ? 'text-light-green' : 'text-red'); ?>"></i>
                                </a>
                            </li>
                            ...
                            <li>
                                <a class="nav-item nav-link f-15 authorize" data-toggle="tab"
                                   ...
                                   aria-controls="nav-authorize" aria-selected="false"><img style="height: 15px;" src="<?php echo e(asset('img/authorize.png')); ?>"> <?php echo app('translator')->get('app.authorize'); ?> <i
                                        class="fa fa-circle ml-1 <?php echo e($credentials->authorize_status == 'active' ? 'text-light-green' : 'text-red'); ?>"></i>
                                </a>
                            </li>
                            ...
                            <li>
                                <a class="nav-item nav-link f-15 square" data-toggle="tab"
                                   ...
                                   aria-controls="nav-square" aria-selected="false"><img style="height: 15px;" src="<?php echo e(asset('img/square.svg')); ?>"> <?php echo app('translator')->get('app.square'); ?> <i
                                        class="fa fa-circle ml-1 <?php echo e($credentials->square_status == 'active' ? 'text-light-green' : 'text-red'); ?>"></i>
                                </a>
                            </li>
                            <li>
                                <a class="nav-item nav-link f-15 flutterwave" data-toggle="tab"
                                   ...
                                   aria-controls="nav-flutterwave" aria-selected="false"><img style="height: 15px;"
                                                                                              src="<?php echo e(asset('img/flutterwave.png')); ?>"> <?php echo app('translator')->get('app.flutterwave'); ?> <i
                                        class="fa fa-circle ml-1 <?php echo e($credentials->flutterwave_status == 'active' ? 'text-light-green' : 'text-red'); ?>"></i>
                                </a>
                            </li>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        $("body").on("click", "#save_paypal_data, #save_stripe_data, #save_razorpay_data, #save_paystack_data, #save_flutterwave_data, #save_mollie_data, #save_payfast_data, #save_authorize_data, #save_square_data", function (event) {
            $.easyAjax({
                url: "<?php echo e(route('payment-gateway-settings.update', [$credentials->id])); ?>",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u561154491/domains/builtinmysore.com/public_html/resources/views/payment-gateway-settings/index.blade.php ENDPATH**/ ?>