...
<?php $component = App\View\Components\Forms\LinkPrimary::resolve(['link' => route('timelogs.create').'?default_assign='.$employee->id,'icon' => 'plus'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    $('#timelogs-table').on('preXhr.dt', function(e, settings, data) {
        ...
        var employee = "<?php echo e($employee->id); ?>";
...
<?php /**PATH /home/u561154491/domains/builtinmysore.com/public_html/resources/views/employees/ajax/timelogs.blade.php ENDPATH**/ ?>