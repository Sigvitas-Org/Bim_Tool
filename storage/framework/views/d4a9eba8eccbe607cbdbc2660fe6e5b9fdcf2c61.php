...
<?php $component->withAttributes([]); ?>
        ...
        <div class="more-filter-items">
            <label class="f-14 text-dark-grey mb-12 text-capitalize" for="usr"><?php echo app('translator')->get('modules.appreciations.appreciationType'); ?></label>
            <div class="select-filter mb-4">
                <select class="form-control select-picker" name="award_type" id="award_type">
                    <option value="all"><?php echo app('translator')->get('app.all'); ?></option>
                    <?php $__currentLoopData = $appreciations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option data-content="<i class='bi bi-<?php echo e($item->awardIcon->icon); ?>' style='color: <?php echo e($item->color_code); ?>'></i> <?php echo e(ucwords($item->title)); ?>"
        ...
        <div class="more-filter-items">
            <label class="f-14 text-dark-grey mb-12 text-capitalize" for="usr"><?php echo app('translator')->get('modules.appreciations.awardTo'); ?></label>
            <div class="select-filter mb-4">
...
<?php $component = App\View\Components\Forms\LinkPrimary::resolve(['link' => route('appreciations.create'),'icon' => 'plus'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
            <div class="btn-group mt-3 mt-lg-0 mt-md-0 ml-lg-3" role="group">
                <?php if($viewAppreciationPermission != 'none'): ?>
                    <a href="<?php echo e(route('appreciations.index')); ?>" class="btn btn-secondary f-14 btn-active" data-toggle="tooltip"
                       data-original-title="<?php echo app('translator')->get('app.menu.appreciation'); ?>"><i class="side-icon bi bi-trophy"></i></a>
                <?php endif; ?>
                <?php if($manageAwardPermission == 'all'): ?>
                    <a href="<?php echo e(route('awards.index')); ?>" class="btn btn-secondary f-14" data-toggle="tooltip"
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        const applyQuickAction = () => {
            ...
            var url = "<?php echo e(route('appreciations.apply_quick_action')); ?>?row_ids=" + rowdIds;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u561154491/domains/builtinmysore.com/public_html/resources/views/appreciations/index.blade.php ENDPATH**/ ?>