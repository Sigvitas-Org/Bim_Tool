    ...
    <div class="card-body p-2">
        <div class="d-flex justify-content-between mb-1">
            <a href="<?php echo e(route('tasks.show', [$task->id])); ?>"
                class="f-12 f-w-500 text-dark mb-0 text-wrap openRightModal"><?php echo e(ucfirst($task->heading)); ?></a>
            ...
            <div class="mb-1 d-flex">
                <?php $__currentLoopData = $task->labels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <span class='badge badge-secondary mr-1'
                        style="background:<?php echo e($label->label_color); ?>"><?php echo e(mb_ucwords($label->label_name)); ?>
            ...
            <?php if($task->project_id): ?>
                <div>
                    <i class="fa fa-layer-group f-11 text-lightest"></i><span
                        class="ml-2 f-11 text-lightest"><?php echo e(ucfirst($task->project->project_name)); ?></span>
                </div>
            <?php endif; ?>
            ...
            <div class="d-flex flex-wrap">
                <?php $__currentLoopData = $task->users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="avatar-img mr-1 rounded-circle">
                        <a href="<?php echo e(route('employees.show', $item->id)); ?>" alt="<?php echo e(mb_ucwords($item->name)); ?>"
                            data-toggle="tooltip" data-original-title="<?php echo e(mb_ucwords($item->name)); ?>"
                ...
                <?php if($task->due_date->endOfDay()->isPast()): ?>
                    <div class="d-flex text-red">
                        <i class="f-11 bi bi-calendar align-self-center"></i><span
                            class="f-12 ml-1"><?php echo e($task->due_date->format(company()->date_format)); ?></span>
                    </div>
...
<?php /**PATH /home/u561154491/domains/builtinmysore.com/public_html/resources/views/components/cards/task-card.blade.php ENDPATH**/ ?>