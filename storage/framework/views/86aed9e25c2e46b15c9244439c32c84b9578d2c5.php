...
<?php $component = App\View\Components\Cards\Notification::resolve(['notification' => $notification,'link' => route('expenses.show', $notification->data['id']),'image' => $notificationUser->image_url,'title' => __('email.newExpense.subject'),'text' => $notification->data['item_name'],'time' => $notification->created_at] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php /**PATH /home/u561154491/domains/builtinmysore.com/public_html/resources/views/notifications/all/new_expense_admin.blade.php ENDPATH**/ ?>