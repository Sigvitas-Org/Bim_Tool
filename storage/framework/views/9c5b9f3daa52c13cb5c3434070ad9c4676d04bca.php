<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('app.update'); ?> <?php echo app('translator')->get('modules.tickets.ticketType'); ?></h5>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'editTicketType','class' => 'ajax-form']); ?>
            <div class="form-body">
                <div class="row">
                    <div class="col-lg-12">
                        <?php if (isset($component)) { $__componentOriginal3985d2df1d9ef7c51070d7c0b8f4b0e4589145ab = $component; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldId' => 'type','fieldLabel' => __('modules.tickets.ticketType'),'fieldName' => 'type','fieldRequired' => 'true','fieldPlaceholder' => __('placeholders.ticketType'),'fieldValue' => $type->type] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    ...
    $('#save-group').click(function () {
        $.easyAjax({
            url: "<?php echo e(route('ticketTypes.update', $type->id)); ?>",
...
<?php /**PATH /home/u561154491/domains/builtinmysore.com/public_html/resources/views/ticket-settings/edit-ticket-type-modal.blade.php ENDPATH**/ ?>