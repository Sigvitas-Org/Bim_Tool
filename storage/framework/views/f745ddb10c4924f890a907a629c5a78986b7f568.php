...
<?php $component = App\View\Components\Forms\Label::resolve(['fieldLabel' => __('app.year'),'fieldId' => 'leave_year'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                    <select class="form-control select-picker" name="leave_year" id="leave_year">
                        <?php for($i = now(company()->timezone)->subYears(2)->year; $i <= now(company()->timezone)->addYear()->year; $i++): ?>
                            <option <?php echo e(now(company()->timezone)->year == $i ? 'selected' : ''); ?>><?php echo e($i); ?>
                ...
                <div class="select-box py-2 px-0 mr-3">
                    <?php if (isset($component)) { $__componentOriginal373f58fa693eb1202c1acc8658ad45d6306ee2ad = $component; } ?>
<?php $component = App\View\Components\Forms\Label::resolve(['fieldLabel' => __('modules.leaves.leaveType'),'fieldId' => 'leave_type'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Label::class))->getConstructor()): ?>
...
<?php endif; ?>
                    <select class="form-control select-picker" name="leave_type" id="leave_type" data-live-search="true"
                        ...
                        <?php $__currentLoopData = $leaveTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leaveType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($leaveType->id); ?>"><?php echo e(mb_ucwords($leaveType->type_name)); ?></option>
...
<?php endif; ?>
        ...
        <div class="d-flex justify-content-between action-bar">
            <div id="table-actions" class="align-items-center">
                <?php if($addLeavePermission == 'all' || ($addLeavePermission == 'added' && user()->id == $employee->id)): ?>
                    <?php if (isset($component)) { $__componentOriginal7f662ecf9f97aca611d2405e5e6903e6081fbd17 = $component; } ?>
<?php $component = App\View\Components\Forms\LinkPrimary::resolve(['link' => route('leaves.create').'?default_assign='.$employee->id,'icon' => 'plus'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                <div class="select-status mr-3 pl-3">
                    <select name="action_type" class="form-control select-picker" id="quick-action-type" disabled>
                        ...
                        <option value="change-leave-status"><?php echo app('translator')->get('app.change'); ?> <?php echo app('translator')->get('app.leaveStatus'); ?></option>
...
<script>
    ...
    $('body').on('click', '.leave-action', function() {
        ...
        var leaveId = $(this).data('leave-id');
        var url = '<?php echo e(route('leaves.leave_action')); ?>';
...
<?php /**PATH /home/u561154491/domains/builtinmysore.com/public_html/resources/views/employees/ajax/leaves.blade.php ENDPATH**/ ?>