<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('modules.tasks.addBoardColumn'); ?></h5>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'createTaskBoardColumn']); ?>
        <div class="row">
            <div class="col-md-6">
                <?php if (isset($component)) { $__componentOriginal3985d2df1d9ef7c51070d7c0b8f4b0e4589145ab = $component; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.tasks.columnName'),'fieldName' => 'column_name','fieldId' => 'column_name','fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mr-0 mr-lg-2 mr-md-2','placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('placeholders.columnName'))]); ?>
...
<?php $component->withAttributes(['id' => 'colorpicker']); ?>
                        <input type="text" class="form-control height-35 f-14"
                            placeholder="<?php echo e(__('placeholders.colorPicker')); ?>" name="label_color" id="colorselector">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-board-column']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    $('#save-board-column').click(function() {
        var url = "<?php echo e(route('taskboards.store')); ?>";
        $.easyAjax({
            url: url,
...
<?php /**PATH /home/u561154491/domains/builtinmysore.com/public_html/resources/views/taskboard/create.blade.php ENDPATH**/ ?>