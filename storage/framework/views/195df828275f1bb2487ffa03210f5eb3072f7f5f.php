                        ...
                        <ul class="nav -primary" id="nav-tab" role="tablist">
                            ...
                            <li>
                                <a class="nav-item nav-link f-15 consent-settings"
                                    ...
                                    aria-controls="nav-consent" aria-selected="true"><?php echo app('translator')->get('app.menu.consent'); ?>
                                    <?php echo app('translator')->get('app.settings'); ?>
                                </a>
                            </li>
                            ...
                            <li>
                                <a class="nav-item nav-link f-15 consent-lists"
                                    ...
                                    aria-controls="nav-consent" aria-selected="true"><?php echo app('translator')->get('app.menu.consent'); ?>
                                    <?php echo app('translator')->get('app.lists'); ?>
                                </a>
                            </li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u561154491/domains/builtinmysore.com/public_html/resources/views/gdpr-settings/index.blade.php ENDPATH**/ ?>