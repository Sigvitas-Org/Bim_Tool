                    ...
                    <nav class="tabs px-4 border-bottom-grey">
                        <div class="nav" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link f-15 client-signup-setting"
                               ...
                               ajax="false"><?php echo app('translator')->get('app.client'); ?> <?php echo app('translator')->get('app.signUp'); ?> <?php echo app('translator')->get('app.settings'); ?>
                            </a>
                            <a class="nav-item nav-link f-15 google-map-setting"
                               ...
                               aria-controls="nav-ticketTypes" aria-selected="true"
                               ajax="false"><?php echo app('translator')->get('app.googleMap'); ?> <?php echo app('translator')->get('app.settings'); ?>
                            </a>
                        </div>
                    </nav>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u561154491/domains/builtinmysore.com/public_html/resources/views/app-settings/index.blade.php ENDPATH**/ ?>