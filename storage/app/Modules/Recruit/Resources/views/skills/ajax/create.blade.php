                    ...
                    <div class="col-lg-5">
                        <div class="form-group my-3">
                            <x-forms.text :fieldLabel="__('recruit::app.menu.skill')"  fieldName="names[]"
                                fieldId="names0" :fieldPlaceholder="__('recruit::modules.skill.skillname')" fieldValue=""
                                fieldRequired="true" />
                        </div>
                    </div>
                </div>
                ...
                <div class="row px-lg-4 px-md-4 px-3 pb-3 pt-0 mb-3  mt-2">
                    <div class="col-md-12">
                        <a class="f-15 f-w-500" href="javascript:;" id="add-item"><i
                                class="icons icon-plus font-weight-bold mr-1 "></i> @lang('app.add') @lang('app.more')</a>
                    </div>
                </div>
                <!--  ADD ITEM END-->
