...
<div class="modal-body">
    <x-form id="addRemark">
        ...
        <div class="row">
            <div class="col-sm-12">
                <x-forms.text fieldId="remark" :fieldLabel="__('recruit::modules.jobApplication.remarks')" fieldName="remark"
                    fieldRequired="true" :fieldPlaceholder="__('app.add'). ' ' . __('recruit::modules.jobApplication.remarks')">
                </x-forms.text>
            </div>
        </div>
    </x-form>
