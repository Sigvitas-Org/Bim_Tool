            ...
            <div class="more-filter-items">
                ...
                <div class="select-filter mb-4">
                    <div class="select-others">
                        <select class="form-control select-picker" name="job" data-live-search="true" data-container="body" id="job">
        ...
        <div class="d-flex justify-content-between action-bar">
            ...
            <div id="table-actions" class="d-block d-lg-flex align-items-center">
                @if ($addJobApplicationPermission == 'all' || $addJobApplicationPermission == 'added')
                    <x-forms.link-primary :link="route('job-applications.create')" class="mr-3 openRightModal" icon="plus">
            ...
            <x-datatable.actions>
                ...
                <div class="select-status mr-3 d-none quick-action-field" id="change-status-action">
                    <select name="status" class="form-control select-picker">
                        @foreach ($applicationStatus as $status)
                            <option value="{{ $status->id }}">{{ $status->slug == ('app.' . 'applied') || $status->slug == ('app.' . 'hired') ? __('app.' . $status->slug) : ucwords($status->status) }}</option>
                        @endforeach
                    </select>
                </div>
            </x-datatable.actions>
            ...
            if (id != "" && status != "") {
                $.easyAjax({
                    ...
                    success: function(response) {
                        ...
                        {
                            if(response.status.category_id == 2){
                            ...
                            if(response.status.category_id == 3 && response.interviewPermission == 'all'){
                            ...
                            if(response.status.category_id == 4 && response.offerLetterPermission == 'all'){
