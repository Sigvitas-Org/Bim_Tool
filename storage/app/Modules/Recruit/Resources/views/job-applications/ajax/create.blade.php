        ...
        <x-form id="save-job-application-data-form">
            <div class="add-client bg-white rounded">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <select @if($jobId) disabled @endif name="job_id" id="job_id" class="form-control select-picker" data-size="8">
                                        <option value="">--</option>
                                        @foreach ($jobs as $job)
                            ...
                            <div class="col-md-3">
                                <x-forms.tel fieldId="phone" :fieldLabel="__('app.mobile')" fieldName="phone"
                    ...
                    <div class="col-md-12" id="resume1">
                        <div class="form-group my-3">
                            <x-forms.label fieldId="resume" fieldRequired="true"
                                ...
                                class="mt-3"></x-forms.label>
                            <input type="file" class="dropify" name="resume" data-allowed-file-extensions="png jpg jpeg pdf" data-messages-default="test" data-height="150" />
                ...
                <x-form-actions>
                    ...
                    <x-forms.button-secondary class="mr-3" id="save-more-job-application" icon="check-double">@lang('app.saveAddMore')
