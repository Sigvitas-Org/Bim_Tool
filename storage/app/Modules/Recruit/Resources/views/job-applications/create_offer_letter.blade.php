                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <x-forms.input-group>
                                <select @if($jobApplications->id) disabled @endif class="form-control select-picker" name="jobApplicant"
                                    id="jobApplicant" data-live-search="true">
                                    <option value="">--</option>
                                    @foreach ($applications as $application)
                                        <option @if($application->id == $jobApplications->id) selected @endif value="{{ $application->id }}">{{ ucfirst($application->full_name) }}</option>
                                    @endforeach
                                </select>
                            </x-forms.input-group>
                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex mt-2">
                                            ...
                                            <x-forms.checkbox fieldId="sendEmail"
                                                :fieldLabel="__('recruit::modules.joboffer.sendEmail')" fieldName="sendEmail" value="on" />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="modal-footer">
    ...
    <x-forms.button-primary class="save-job-form" id="save-job-form" icon="check">@lang('app.save')</x-forms.button-primary>
</div>
