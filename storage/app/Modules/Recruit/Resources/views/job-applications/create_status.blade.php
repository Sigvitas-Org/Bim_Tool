        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('recruit::modules.jobApplication.status')"
                    fieldName="status" fieldId="status" :placeholder="__('recruit::modules.jobApplication.status')"
                    fieldRequired="true" />
            </div>
            ...
            <div class="col-md-6">
                <x-forms.select fieldId="position" fieldName="position" :fieldLabel="__('recruit::modules.jobApplication.position')">
...
<script>
    ...
    $('body').on('click', '#save-board-column', function() {
