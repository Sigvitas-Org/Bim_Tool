            ...
            <x-form id="save-event-data-form">
                ...
                <div class="row py-20">
                    ...
                    <div class="col-md-3">
                        ...
                        <x-forms.input-group>
                            <select class="form-control select-picker job-app" name="jobStage"
                                id="jobStage" data-live-search="true">
                                <option value="">--</option>
                                @if($jobId)
                                    @foreach ($selectedStages as $stage)
                                        <option value="{{ $stage->stage->id }}">{{ ucfirst($stage->stage->name) }}</option>
                                    @endforeach
                                @else
                ...
                <x-form-actions>
                    ...
                    <x-forms.button-secondary class="mr-3" id="save-more-event-form" icon="check-double">@lang('app.saveAddMore')
