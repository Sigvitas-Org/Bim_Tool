...
@section('filter-section')
    ...
    <div class="d-flex filter-box project-header bg-white">
        ...
        <div class="project-menu d-lg-flex" id="mob-client-detail">
            ...
            <x-tab :href="route('interview-schedule.show', $interview->id).'?view=evaluations'" :text="__('recruit::modules.interviewSchedule.evaluations')"
            ...
            <x-tab :href="route('interview-schedule.show', $interview->id).'?view=history'" :text="__('modules.tasks.history')"
