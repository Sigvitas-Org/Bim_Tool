                ...
                <td>
                    ...
                    @else
                        @if ($link->status == 'active')
                            <i class="fa fa-circle mr-1 text-light-green f-10"></i>@lang(ucfirst($link->status))
                        @else
                            <i class="fa fa-circle mr-1 text-red f-10"></i>@lang(ucfirst($link->status))
                        @endif
                    @endif
                </td>
...
<script>
     /* delete link */
     $('body').on('click', '.delete-footer', function() {
