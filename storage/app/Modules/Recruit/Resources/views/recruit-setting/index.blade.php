                    ...
                    <nav class="tabs px-4 border-bottom-grey">
                        <div class="nav" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link f-15 active general-setting"
                                href="{{ route('recruit-settings.index') }}" role="tab" aria-controls="nav-recruit-setting"
                            ...
                            aria-controls="nav-recruit-setting" aria-selected="true" ajax="false">@lang('recruit::app.menu.footerSettings')
                            </a>

                            <a class="nav-item nav-link f-15 recruit-setting"
                            href="{{ route('recruit-settings.index') }}?tab=recruit-setting" role="tab"
                            aria-controls="nav-recruit-setting" aria-selected="true" ajax="false">@lang('recruit::app.menu.recruitersSettings')
                            </a>

                            <a class="nav-item nav-link f-15 recruit-email-notification-setting"
                            href="{{ route('recruit-settings.index') }}?tab=recruit-email-notification-setting" role="tab"
                            aria-controls="nav-recruit-setting" aria-selected="true" ajax="false">@lang('recruit::modules.emailNotification.notificationSetting')
                            </a>
                        </div>
                    </nav>
                </div>
