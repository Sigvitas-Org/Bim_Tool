    ...
    <div class="portlet-body">
        <x-form id="createMethods" method="POST" class="ajax-form">
            <div class="row">
                ...
                <div class="col-md-4">
                    <x-forms.text fieldId="slug" :fieldValue="$footerLink->slug" :fieldLabel="__('recruit::modules.footerlinks.slug')"
                ...
                <div class="col-md-12">
                    <div class="form-group my-3">
                        <x-forms.label class="my-3" fieldId="description-textt" :fieldValue="$footerLink->job_description"
...
<script>
    ...
    $('body').on('click', '#save-footer', function() {
