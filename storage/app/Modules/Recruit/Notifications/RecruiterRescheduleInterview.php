...
class RecruiterRescheduleInterview extends Notification implements ShouldQueue
{
    use Queueable;
    private $interview;
    ...
    public function toMail($notifiable)
    {
        $emailContent = (new MailMessage)
            ...
            ->line(__($this->interview->jobApplication->full_name).' '.__('recruit::modules.email.rescheduleText').' - ' . ucwords($this->interview->jobApplication->job->title));
