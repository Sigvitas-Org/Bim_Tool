...
class CandidateRescheduleInterview extends Notification implements ShouldQueue
{
    use Queueable;
    private $interview;
    private $user;
    ...
    public function toMail($notifiable)
    {
        $emailContent = (new MailMessage)
            ...
            ->line(__('recruit::modules.email.your').' '.__('recruit::modules.email.rescheduleText').' - ' . ucwords($this->interview->jobApplication->job->title))
