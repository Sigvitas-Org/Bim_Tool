...
class JobTypeController extends AccountBaseController
{
    ...
    public function store(StoreJobType $request)
    {
        ...
        foreach ($jobTypes as $stage) {
            ...
            data-content="<span class=\'badge badge-pill badge-light border\'><div class=\'d-inline-block mr-1\'></div> ' . ucfirst($stage->job_type) . ' </span>"
            value="' . $stage->id . '"> ' . ucwords($stage->job_type) . '</option>';
        }
