...
class NewAppreciation extends BaseNotification
{
    ...
    public function toMail($notifiable)
    {
        return parent::build()
            ...
            ->line(__('email.newAppreciation.text', ['award' => $this->userAppreciation->award->title, 'award_at' => $this->userAppreciation->award_date->format($this->company->date_format)]))
            ->action(__('email.newAppreciation.action'), route('appreciations.show', $this->userAppreciation->id))
