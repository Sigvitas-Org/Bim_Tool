...
class CompanyObserver
{
    ...
    private function currencyFormat($company)
    {
        $format = new CurrencyFormatSetting();
        $format->company_id = $company->id;
    ...
    private function moduleSetting($company)
    {
        $moduleSettings = [
            ['type' => 'employee', 'module_name' => 'projects', 'status' => 'active', 'company_id' => $company->id],
            ['type' => 'employee', 'module_name' => 'messages', 'status' => 'active', 'company_id' => $company->id],
            ['type' => 'employee', 'module_name' => 'notices', 'status' => 'active', 'company_id' => $company->id],
            ['type' => 'employee', 'module_name' => 'leads', 'status' => 'active', 'company_id' => $company->id],

            ['type' => 'client', 'module_name' => 'invoices', 'status' => 'active', 'company_id' => $company->id],
            ['type' => 'client', 'module_name' => 'projects', 'status' => 'active', 'company_id' => $company->id],
        ];
    ...
    private function moduleSettings($company)
    {
        ...
        foreach ($data as $type => $moduleList) {
            ...
            foreach ($moduleList as $module) {
                $moduleSettings[] = ['company_id' => $company->id, 'type' => $type, 'module_name' => $module, 'status' => 'active'];
            }
