...
class ContractsDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $datatables
            ...
            ->editColumn('end_date', function ($row) {
                ...
                return $row->end_date == null ? $row->end_date : $row->end_date->format($this->company->date_format);
            })
    ...
    protected function getColumns()
    {
        return [
            ...
            __('app.contract_number') => ['data' => 'contract_number', 'name' => 'contract_number', 'title' => '#'],
