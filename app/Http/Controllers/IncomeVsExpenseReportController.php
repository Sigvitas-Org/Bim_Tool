...
class IncomeVsExpenseReportController extends AccountBaseController
{
    ...
    public function getGraphData()
    {
        ...
        foreach ($invoices as $invoice) {
            ...
            if ($invoice->currency_id != $this->company->currency->id && $invoice->total > 0 && $invoice->exchange_rate > 0) {
        ...
        foreach ($expenseResults as $expenseResult) {
            ...
            if ($expenseResult->currency_id != $this->company->currency->id && $expenseResult->price > 0 && $expenseResult->exchange_rate > 0) {
                /** @phpstan-ignore-next-line */
