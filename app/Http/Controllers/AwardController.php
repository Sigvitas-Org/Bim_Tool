...
class AwardController extends AccountBaseController
{
    ...
    public static function options($items, $group = null): string
    {
        ...
        foreach ($items as $item) {
            ...
            $options .= '<option ' . $selected . '  data-content="'.$icon .' '. ucwords($name) .'" value="'.$item->id.'">
                                                '.mb_ucwords($name).'
                                            </option>';
        }
    ...
    public function store(StoreRequest $request)
    {
        ...
        return Reply::successWithData(__('messages.awardAdded'), ['redirectUrl' => route('awards.index')]);
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        return Reply::successWithData(__('messages.updatedSuccessfully'), ['redirectUrl' => route('awards.index')]);
    }
