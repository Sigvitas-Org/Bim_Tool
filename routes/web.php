...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    Route::get('attendances/export-all-attendance/{year}/{month}/{id}/{late}/{department}', [AttendanceController::class, 'exportAllAttendance'])->name('attendances.export_all_attendance');
